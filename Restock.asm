...
print_header PROC
    lea dx, res_Header ; Load the address of the header message
...
main PROC
    ...
    call res_clear_screen ; Clear the screen
    call print_header ; Display the header
    ...
    prompt_user_action PROC
        lea dx, res_prompt_action ; Load prompt message
